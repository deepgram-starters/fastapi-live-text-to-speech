...
FastAPI demo app for Deepgram Live Text-to-Speech.
...
```
feat(fastapi-live-text-to-speech): add diarization support
fix(fastapi-live-text-to-speech): resolve WebSocket close handling
refactor(fastapi-live-text-to-speech): simplify session endpoint
